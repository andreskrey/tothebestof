...
<div class="row-fluid">
	<div class="span12">
		<h2><?php echo sprintf( '¿Está seguro que desea borrar de la colección <em>%s</em> el registro <em>%s</em>?', 'Hit', $hit['Hit']['name'] ) ?></h2>
		...
		<div class="form-actions">
			<?php echo $this->BootstrapForm->postLink( 'Estoy seguro', array( 'action' => 'delete', $hit['Hit']['id'] ), array( 'class' => 'btn btn-danger', 'icon' => 'ok white' ) ); ?>
