...
<div class="row-fluid">
    <div class="span12">
        ...
        <fieldset>
            ...
            echo $this->BootstrapForm->input('Email.config', array(
                'label'    => 'Configuración',
                'options'  => $configs,
                'value'    => $email['Email']['config'],
                'required' => TRUE,
                'class'    => 'span8',
                //'helpInline' => '',
                //'helpBlock' => '',
            ));
            echo $this->BootstrapForm->input('Email.from_name', array(
            ...
            echo $this->BootstrapForm->input('Email.from_email', array(
                'label'    => 'Email Remitente',
                'value' => $email['Email']['from_email'],
                'required' => TRUE,
                'class'    => 'span8',
                //'helpInline' => '',
                //'helpBlock' => '',
            ));
            echo $this->BootstrapForm->input('Email.subject', array(
                'label'    => 'Asunto',
