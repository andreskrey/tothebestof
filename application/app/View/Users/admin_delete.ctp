...
<div class="row-fluid">
	<div class="span12">
		<h2><?php echo sprintf( '¿Está seguro que desea borrar de la colección <em>%s</em> el registro <em>%s</em>?', 'Usuario', $user['User']['id'] ) ?></h2>
		...
		<div class="form-actions">
			<?php echo $this->BootstrapForm->postLink( 'Estoy seguro', array( 'action' => 'delete', $user['User']['id'] ), array( 'class' => 'btn btn-danger', 'icon' => 'ok white' ) ); ?>
